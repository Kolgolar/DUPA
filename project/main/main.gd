...
@export var _node_popup: PopupMenu
...
func _on_NewNode_pressed():
	# _create_new_node("res://project/nodes/LineNodeLite.tscn")
	pass
	# TODO: Autosave?
...
func _on_graph_node_rmb_pressed(node: GraphNode):
	...
	_node_popup.popup()
	_node_popup.position = get_local_mouse_position()
...
func load_save(path, fn):
	...
	for graph_node in timeline:
		...
		match timeline[graph_node]["type"]:
			"LINE":
				if _lite_line_nodes:
					node_scene_path = "res://project/nodes/node_line_lite.tscn"
				else:
					node_scene_path = "res://project/nodes/node_line.tscn"
			"DYNAMIC_LINE":
				node_scene_path = "res://project/nodes/node_dynamic_line_lite.tscn"
			"CONDITION":
				node_scene_path = "res://project/nodes/node_condition.tscn"
			"START":
				node_scene_path = "res://project/nodes/node_start.tscn"
			"SETTER":
				node_scene_path = "res://project/nodes/node_setter.tscn"
			"CALLER":
				node_scene_path = "res://project/nodes/node_caller.tscn"
			_:
...
func _on_MousePopup_id_pressed(id:int):
	match id:
		0:
			_create_graph_node("res://project/nodes/node_start.tscn", _mouse_popup.position, true)
		1:
			if _lite_line_nodes:
				_create_graph_node("res://project/nodes/node_line_lite.tscn", _mouse_popup.position)
			else:
				_create_graph_node("res://project/nodes/node_line.tscn", _mouse_popup.position)
		2:
			_create_graph_node("res://project/nodes/node_condition.tscn", _mouse_popup.position)
		3:
			_create_graph_node("res://project/nodes/node_setter.tscn", _mouse_popup.position)
		4:
			_create_graph_node("res://project/nodes/node_caller.tscn", _mouse_popup.position)
		5:
			_create_graph_node("res://project/nodes/node_dynamic_line_lite.tscn", _mouse_popup.position)
		_:
			printerr("Unknown id!")
